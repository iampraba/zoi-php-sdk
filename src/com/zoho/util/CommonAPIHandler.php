...
use com\zoho\util\JSONConverter;

use com\zoho\util\Downloader;

use com\zoho\util\FormDataConverter;

use com\zoho\util\XMLConverter;
...
class CommonAPIHandler
{
     ...
     * @return \com\zoho\util\APIResponse A APIResponse representing the Zoho API response instance or null.
     */

...
class Initializer
{
     ...
     *
     * @param UserSignature $user A UserSignature class instance represents the user.
     ...
     */
    public static function initialize($user, $environment, $token, $store, $sdkConfig, $logger=null, $proxy=null)
    {
        try
        {
     ...
     *
     * @return UserSignature A User class instance representing the user.
     */

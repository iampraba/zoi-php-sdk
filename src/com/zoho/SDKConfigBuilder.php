...
class SDKConfigBuilder
{
    ...
    {
        return new \com\zoho\sdkconfigbuilder\SDKConfig($this->autoRefreshFields, $this->pickListValidation, $this->enableSSLVerification, $this->connectionTimeout, $this->timeout);
    }
}

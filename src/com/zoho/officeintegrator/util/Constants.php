...
class Constants
{
    ...
    const PACKAGE_NAMESPACE = "com\\zoho\\officeintegrator";
    ...
    const ERROR = "error";
    const OAUTH_HEADER_PREFIX = "Bearer ";
    ...
    const CHOICE_NAMESPACE = "com\\zoho\\officeintegrator\\util\\Choice";
    const INFO = "info";
    const READ = "read";
    const RESULT = "result";
    const UPLOAD = "upload";
    ...
    const VALUES = "values";
    const TYPE = "type";
    const STREAM_WRAPPER_CLASS_PATH = "com\\zoho\\officeintegrator\\util\\StreamWrapper";
    const FIELD = "field";
    ...
    const TOKEN_INITIALIZATION_ERROR = 'Exception in OAuth2 constructor';
    ...
    const FILE_NAMESPACE = "com\\zoho\\officeintegrator\\util\\StreamWrapper";
	...
	const HEADER = "header";
	const PARAM = "param";
    const OAUTH_MANDATORY_KEYS1 = [Constants::CLIENT_ID, Constants::CLIENT_SECRET];
	const OAUTH_MANDATORY_KEYS2 = [Constants::GRANT_TOKEN, Constants::REFRESH_TOKEN];
    const OAUTH_MANDATORY_KEYS_1 = ["AuthenticationType"];
    const AUTHENTICATION_SCHEMA = "authentication_schema";
    const GET_TOKEN_BY_USER_NAME_ERROR = "Exception in getToken() - OAuth2 : Given user_name token details not found, Please give required item"; // No I18N
    const CONTENT_TYPE_1 = "Content-Type";
    const CONTENT_TYPE_2 = "ontent-Type";
    const SCHEMA_NAME = "schema_name";
    const AUTHENTICATION = "authentication";
    const SDK_OPERATIONS_METHOD_DETAILS_NOT_FOUND_IN_JSON_DETAILS_FILE = "SDK Operations method details not found in JSON details file"; // No I18N
	const SDK_OPERATIONS_CLASS_DETAILS_NOT_FOUND_IN_JSON_DETAILS_FILE = "SDK Operations class details not found in JSON details file";
    const REQUEST = "request";
    const SUB_TYPE = "sub_type";
    const MEMBERS = "members";
    const TFILE_TYPE = "com.zoho.api.spec.template.type.TFile";
    const GROUP_TYPE = "group_type";
    const SPEC_TYPE = "spec_type";
    const TIMEZONE_NAMESPACE = "TimeZone";
    const LOCALTIME_NAMESPACE = "LocalTime";
    const REQUEST_SUPPORTED = "request_supported";
    const  REQUIRED_FOR = "required_for";
    const EXTRA_DETAILS = "extra_details";
    const TARRAY_TYPE = "com.zoho.api.spec.template.type.TArray";
    const ORDERED_STRUCTURES = "ordered_structures";

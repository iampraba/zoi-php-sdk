...
class ShowCallbackSettings implements Model
{
	 ...
	 * @return string A string representing the contextInfo
	 */
	 ...
	 * @param string $contextInfo A string
	 */
	public  function setContextInfo(string $contextInfo)
	{
